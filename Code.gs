/* ==========================================================================
   ...
   Production Google Apps Script Backend API (Google Sheets Database + Drive)
   ========================================================================== */

const FOLDER_NAME = "Abhyas Coaching Uploads";
...
function doPost(e) {
  ...
  try {
    ...
    if (action === "uploadFileDrive") {
      result = uploadFileToDrive(postData.fileData, postData.fileName, postData.mimeType);
